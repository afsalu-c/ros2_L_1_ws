...
public:
   ...
   client_->async_send_request(
    request,std::bind(&AddTwoIntsClientNode::callbackAddTwoInts, this, _1)); 
...
int main(int argc, char **argv)
{
   ...
   node->callAddTwoInts(10, 6);
   node->callAddTwoInts(-8, 6);
   node->callAddTwoInts(3, 16);
   node->callAddTwoInts(10, 96);
   rclcpp::spin(node);
   rclcpp::shutdown();
   return 0;
}
